...
| Translation operations | `contents: read` | none | Disposable test DSW only; no production, Git or Weblate writes |
| Native locale release | `contents: write` | none | Publishes assets after disposable DSW verification; no production DSW or Weblate writes |
