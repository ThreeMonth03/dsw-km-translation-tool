...
| PO parsing, escaping, or rewrite output | [`po.py`][po-py] | [`po_support/parser.py`][po-parser-py], [`po_support/codec.py`][po-codec-py], [`po_support/render.py`][po-render-py], [`po_support/writer.py`][po-writer-py] | PO tests under [`tests/translation/`][tests-translation] |
| KM event merge, tree derivation, or locale validation | [`knowledge_model_service.py`][km-service-py], [`native_locale.py`][native-locale-py] | [`knowledge_model_support/`][km-support-dir], [`dsw_models_adapter.py`][dsw-models-adapter-py] | [`tests/infra/test_dsw_models_parser.py`][test-dsw-models-py], [`tests/infra/test_native_locale.py`][test-native-locale-py] |
...
| GitHub translation PR/import policy | [`github_translation_contributions.py`][github-translation-contributions-py], [`weblate_upload.py`][weblate-upload-py] | PO state parsing in [`po_support/state.py`][po-state-py], Markdown comparison in [`translation_format.py`][translation-format-py], shared-tree checks in [`shared_block_consistency.py`][shared-block-consistency-py], and the Weblate upload client | [`tests/infra/test_github_translation_contributions.py`][test-github-translations-py], [`tests/infra/test_translation_format.py`][test-translation-format-py], [`tests/infra/test_weblate_upload.py`][test-weblate-upload-py] |
...
- Keep GitHub Actions YAML as orchestration; branch selection, GitHub import
  policy, locale validation, and commit decisions belong in Python.
...
[native-locale-py]: https://github.com/ThreeMonth03/dsw-km-translation-tool/blob/master/src/dsw_km_translation_tool/native_locale.py
...
[shared-block-consistency-py]: https://github.com/ThreeMonth03/dsw-km-translation-tool/blob/master/src/dsw_km_translation_tool/shared_block_consistency.py
...
[test-native-locale-py]: https://github.com/ThreeMonth03/dsw-km-translation-tool/blob/master/tests/infra/test_native_locale.py
...
[test-translation-format-py]: https://github.com/ThreeMonth03/dsw-km-translation-tool/blob/master/tests/infra/test_translation_format.py
